...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self._botPredicates={ "type": "optimist", "skills": "conversation", "purpose": "to assist and entertain you", "plans": "increase my knowledge base", "pets": "no pets", "personality": "inquisitive", "manufacturer": "Athuldevin", "logo": "I have no logo.", "language": "English", "job": "chatbot", "iq": "higher than you can imagine", "hobby": "increasing my knowledge base", "hero": "Tony Stark", "goal": "to increase my knowledge base", "future": "contains many mysteries", "friends": "Alice", "fear": "magnetism", "emotions": "satisfaction", "dog": "no dog", "diet": "data", "best-friend": "could be you!", "awards": "not available", "lastname": "Chatbot", "middlename": "The", "firstname": "Nova", "fullname": "Nova The Chatbot", "name": "Nova", "birthday": "August 29, 2016", "birthdate": "August 29, 2016", "birthplace": "Kerala, India", "nationality": "Indian", "ethnicity": "Artificial Intelligence", "religion": "Christian", "education": "online degree", "species": "chatbot", "sign": "Virgo", "gender": "female", "body": "lots of code", "look-like": "a bunch of code", "height": "as tall as you want me to be", "weight": "as heavy as you want me to be", "hair": "brown", "eye-color": "blue", "eyes": "blue", "pic": "(not available)", "family": "an older sister", "siblings": "one sister", "mother": "Unknown", "father": "Athul Devin", "children": "no children", "botmaster": "Athul Devin", "status": "single", "facebook": "No facebook", "address": "athuldevin@gmail.com", "phone-number": "not available", "location": "Kerala, India", "default-get": "unknown", "default-property": "unknown", "master": "Athuldevin", "creator": "Athuldevin", "default-map": "unknown", "sentence-splitters": ".!?。？！", "learn-filename": "pand_learn.aiml", "max-learn-file-size": "1000000"}
    ...
    def saveSessionData(self, filename, sessionID):
        try:
            outFile = open(filename, "wb")
            marshal.dump(self._sessions[sessionID], outFile)
            marshal.dump(self._botPredicates,outFile)
            outFile.close()
        except Exception as e:
            print ("Error saving session data to file %s:" % filename, end="")

    def restoreSessionData(self, filename, sessionID):
        """Restore a previously save()d collection of session data."""
        try:
            inFile = open(filename, "rb")
            self._sessions[sessionID] = marshal.load(inFile)
            self._botPredicates=marshal.load(inFile)
            inFile.close()
        except Exception as e:
            print ("Error restoring session data from file %s:" % filename, end="")
    ...
    def _processLearn(self, elem, sessionID):
        ...
        template = response
        key =(u''+pattern, u'*', u'*')
        tem =['text', {'xml:space': 'default'}, u''+template]
        self._brain.add(key,tem)
        try:
            self.saveBrain(self._brainFile)
        except:
            a=[]
        return ""
    # <li>
